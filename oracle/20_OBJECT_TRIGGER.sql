 /*
    ...
    - 테이블이나 뷰가 DML(INSERT, UPDATE, DELETE) 문에 의해 변경될 경우
        ...
        EX)
        - 회원 탈퇴시 기존의 회원 테이블에 데이터 DELETE 후
        곧 바로 탈퇴된 회원들만 따로 보관하는 테이블에 자동으로INSERT처리
...
END;
/
 INSERT INTO EMPLOYEE(EMP_ID,EMP_NAME,EMP_NO) VALUES(500,'장밥두밥','123-123123');
 
 INSERT INTO EMPLOYEE(EMP_ID,EMP_NAME, EMP_NO) VALUES(501,'노석두리두리','222220-332133');
